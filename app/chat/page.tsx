...
export default function ChatView() {
  ...
  const [listItems] = useState<ListItem[]>([
    ...
    },
    {
      id: "4",
      name: "Security Scan",
      description: "Automated security vulnerability assessment and reporting",
    },
    {
      id: "5",
      name: "SEO Optimization",
      description: "Search engine optimization recommendations and analysis",
    },
    {
      id: "6",
    ...
    },
    {
      ...
      description: "Automated API documentation generation and validation",
    },
    {
      id: "10",
    ...
    },
    {
      ...
      description: "Content quality assessment and improvement suggestions",
    },
    {
      id: "12",
      name: "Mobile Responsiveness",
      description: "Mobile device compatibility and responsive design testing",
    },
    {
      id: "13",
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const assistantMessage: Message = {
        ...
        content: `I've analyzed your request about "${inputMessage}". Here's what I found: This is a simulated response that would normally come from your API. The analysis shows various insights and recommendations based on your input.`,
        sender: "assistant",
        timestamp: new Date(),
      };
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 max-w-7xl mx-auto w-full overflow-hidden max-h-250 p-6 pb-12">
        {/* Sidebar */}
        <aside className="w-80 bg-gray-50 flex flex-col overflow-y">
          <Card className="flex-1 flex flex-col border border-gray-200 shadow-sm rounded-lg overflow-hidden">
            <div className="space-y-2 p-4 overflow-y-auto">
              {listItems.map((item) => (
                <Card
                  key={item.id}
                  className="p-3 hover:bg-white transition-colors cursor-pointer border-gray-200"
                >
        ...
        <main className="flex-1 flex flex-col overflow-hidden ml-4">
          <Card className="py-0 flex-1 flex flex-col border border-gray-200 shadow-sm rounded-lg overflow-hidden">
            ...
            <div className="border-t border-gray-200 p-4 bg-gray-50">
              <div className="flex space-x-2 items-end">
                <Textarea
                  ...
                  disabled={isLoading}
                  className="flex-1 h-120 min-h-[40px] max-h-[120px]"
                  rows={1}
                />
                <Button
                  onClick={sendMessage}
